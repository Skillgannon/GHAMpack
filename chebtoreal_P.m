...
% - ww: Precomputed contants for calculating the DCT, that take up the bulk
% of the computational cost of the dct when used multiple times
% 
...
% real space
u=idct_fast_P(sqrt(N/2)*[in(1)*sqrt(2), in(2:end)],ww);